...
footer#rodape p{
 ...
 .f5{
color:#0096dd;;text-decoration:none;padding:0 0 0 10px
} 
...
</svg>Centro de Ajuda</h3>   
<div id="conteudo3"> 
<article>


<p>Oficina Office sistema desenvolvido e assistido pela TechBrains para armazenamento e gerenciamento de dados,um sistema multiplataforma ,significa que é adaptável em qualquer dispositivo que tenha um aplicativo em seu sistema.</p><br>


<p>Ao iniciar o sistema será redirecionado na página inicial do sistema onde verá o logo da Empresa/oficina e sua legenda pela barra que se encontra no topo da página,como poderá atualizar , ver a data, hora e também poderá terminar uma sessão através dos icones que se encontram no topo da página inicial.</p>
<br>
<p>Terá uma barra de pesquisa que se encontra no centro de sua página inicial,é uma barra de pesquisa dinâmica, significa que apartir dela poderá procurar por um veículo que se encontra cadastrado, a pesquisa de um veículo será realizada quando digitar a  <span style="color:#0096dd">matrícula </span> do mesmo.</p><br>

<p>Estando na página inicial Poderá aceder as páginas seguintes pelas opções que se encontram no seu menu principal como também pelas opções que se encontram centralizadas em sua página inicial tais como:</p>
 <ul style="margin:28px 0 0 28px">
<li><strong>Manutenção de viaturas:</strong> aqui é onde será cadastrado as informações do veículo e do propretário da mesma<a href="#" class="f5">ver mais...</a></li><br>  
<li><strong>Revisão de viaturas:</strong> aqui é onde será feito a revisão de um veículo já cadastrado no sistema<a href="#" class="f5">ver mais...</a></li><br>
<li><strong>Faturamento:</strong> aqui será feito o pagamento do serviço prestado ao cliente <a href="#" class="f5">ver mais...</a></li><br>
<li><strong>Funcionários:</strong> aqui é onde será cadastrado todo o funcioário que presta serviço na oficina <a href="#" class="f5">ver mais...</a></li><br>
<li><strong>Histórico Funcionários:</strong> aqui poderá ver os funcionários que se encotram cadastrados no sitema<a href="#" class="f5">ver mais...</a></li><br>
<li><strong>Veículos:</strong> aqui poderá ver os veículos que se encotram cadastrados no sitema<a href="#" class="f5" >ver mais...</a></li><br>
<li><strong>Relatório:</strong> aqui poderá ter o relatório de faturas ja realizadas pelo sitema <a href="#" class="f5">ver mais...</a></li><br>
</ul>
