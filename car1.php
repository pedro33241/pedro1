...
<link rel="stylesheet" type="text/css" href="javascript/sweetalert2.css">
...
.hamburguer:before{
  ...
  border-top: none; float:right;
   text-align:center;  width:91%;float:right;
  text-align:justify; 
...
.pace .pace-progress {
 background: #0b6884;
  ...
  <body >    
  <div id="of1">  
  <a href='man.php' class="btn1 btn2" title="Cadastro" rel="next" >Cadastrar</a>
...
<div class="menu5">
 ...
 <li class="list"><a href="fat.php"  rel="next"   class="ref" >
  
 <span class="icon" style=" color:#4a7c94">  
...
<li class="list"><a href="car.php"  rel="next"  class="ref" style="background:#1e1e1e">
...
<section id="main">
    ...
    <h3 style=" font-weight:normal;"><svg width=".7em" height=".7em" viewBox="0 0 16 16" fill="currentColor"
  xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" d="M11.5 4a.5.5 0 0 1 .5.5V5h1.02a1.5 1.5 0 0 
  1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-4 0 1 1 
  0 0 1-1-1v-1h11V4.5a.5.5 0 0 1 .5-.5zM3 11a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm1.73
  2 0A2 2 0 0 0 12 10V6h1.02a.5.5 0 0 1 .39.188l1.48 1.85a.5.5 0 0 1 .11.313V10.5a.5.5 0 0 1-.5.5h-.768z"/> </svg>
  Histórico de Veículos</h3> 
   <nav id="atualizar" title="Procurar">
<form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>"><div class="RNNXgb" jsname="RNNXgb"><div class="SDkEP"><div class="iblpc" jsname="uFMOof"> <div class="hsuHs"><span class="wFncld z1asCe MZy1Rb"><svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24"><path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"></path></svg></span></div></div><div jscontroller="iDPoPb" class="a4bIc" jsname="gLFyf" jsaction="h5M12e;input:d3sQLd;blur:jI3wzf"> <div class="pR49Ae gsfi" jsname="vdLsw"></div><input class="gLFyf yy1 gsfi" maxlength="2048" name="q" type="search" jsaction="paste:puy29d" aria-autocomplete="both" placeholder="Procurar Veículo" aria-haspopup="false" autocapitalize="off" autocomplete="off" autocorrect="off" autofocus="" role="combobox" spellcheck="false" title="Pesquisar" value="" aria-label="Pesq." data-ved="0ahUKEwjziqjGhZztAhWvz4UKHSiFDTIQ39UDCAQ"></div><div class="dRYYxd">   <span class="FqnKTc"></span></nav>
...
if (isset($_POST['search'])) {
  ...
  $sql="SELECT * FROM manutencao WHERE nome LIKE '%$nome%'";
...
session_unset();
  ...
  <table cellspacing="10" class="f5" cellpadding="5" ><br>
...
<td style="color:#373941">
            Entidade</td>
         <td style="color:#373941">Nome</td>
        <td style="color:#373941">Sobrenome</td>
      <td style="color:#373941">Cidade</td>
     <td style="color:#373941">Endereço</td>
    <td style="color:#373941">Telefone</td>
  <td><button type="submit" title="Nova revisão" onclick=" " style=" 
   border-radius:4%;border:none; " ><span class="p"><a href="man2.php?id=<?php echo $dados['id'];?>" class="p1">Revisão</a></span></button></td>
<style type="text/css"> 

.p1{    font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;
  color: white;
    text-decoration: none;
   
  background-color:#0eef0e;
 width:97%;padding:7px 29px 7px 29px; border:none;font-size:14px} 
  .p1:hover{   background-color:#09d909;
  }
.p4{
  font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;
  color: white;
...
<td style="border:none;color:#a90969;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:18px; "><?php echo $dados['entidade'];?></td>
<td  style="border:none;color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px;font-size:18px;  " ><?php echo $dados['nome'];?></td>
<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['sobrenome'];?></td>
...
<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['local1'];?></td>
...
<tr  class="f" style="color:#4d4c4c;
        ...
        "> <td style="color:#373941">Telefone(2)</td>
  
 <td style="color:#373941">Email</td> 
 
<td style="color:#373941">Marca</td>
<td style="color:#373941">Modelo</td>
<td style="color:#373941">Class</td>
<td style="color:#373941">Nº do motor</td>
   
<td ><button type="submit" title="Deletar Registo" style="   border-radius:4%;border:none;"><span><a href="backend/delete.php?id=<?php echo $dados['id'];?>" value="Limpar Campos" class="p4" onclick="return confirm('Tem certeza que deseja deletar esse cliente?' ); return false;">Apagar</span></button></td>
...
<div class="ops">
 <td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['telefone2'];?></td>
 

<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['email'];?></td>
 

<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['marca'];?></td>
<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['modelo'];?></td>
<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['classe'];?></td>
<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['motor'];?></td>   </div>
</tr> 
<tr  class="f" style="color:#4d4c4c;
        font-size:18px;
        text-align: center;
        ...
        ">
            <td style="color:#373941">Matrícula</td>
<td style="color:#373941"> Caixa</td>
 
  <td style="color:#373941">Combustível</td> 
  
    <td style="color:#373941">Serviço</td>
    <td style="color:#373941">Cor</td>
     <td style="color:#373941">Km</td>
        
<td ><button type="submit" title="Imprimir Registo" style=" 
 border-radius:4%;border:none; " onclick=" "><span ><a href="man.php?id=<?php echo $dados['id'];?>" class="p6">Imprimir</a></span></button></td>
...
<td style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:18px; "><?php echo $dados['matricula'];?></td>
<td  style=";color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px;"><?php echo $dados['caixa'];?></td> 
<td  style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['combustivel'];?></td>
<td  style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['servico'];?></td> 

<td  style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['cor'];?></td> 
<td  style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['km'];?></td>
...
<tr  class="f" style="color:#4d4c4c;
        ...
        ">   <td style="color:#373941">Manutenção</td>
       <td style="color:#373941">Situação</td>
      <td style="color:#373941">Nº revisões</td>
         <td style="color:#373941"> Observação</td>
         <td style="color:#373941">Proxima Revisão</td>
         
         <td style="color:#373941">Hora</td>
...
<div class="ops">
<td  style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['checagem'];?></td> 
<td class="ob"  title="pare o mouse!" style="border:none;color:black;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; text-align:center;color: #ba1515;"><?php echo $dados['situacao'];?></td>
 
<td  style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['revisao'];?></td> 
   <td  style="border:none;color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px;text-align: justify; "><?php echo $dados['observacao'];?></td>
<td  style="border:none;color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['datac'];?></td>
 
<td style="border:none;color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:18px; "><?php echo $dados['hora'];?></td>
...
<tr  class="f" style="color:#4d4c4c;
        ...
        ">    
           <td style="color:#373941">Mecanico</td>
            <td style="color:#373941">Operador/a</td>
...
<div class="ops"> 
<td style="border:none;color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:18px; "><?php echo $dados['mecanico'];?></td>
<td  style="border:none;color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px;"><?php echo $dados['operador'];?></td>
...
<div class="f6" > 
   ...
   <button onclick="backToTop()" id="btnTop"><svg width="1em" height="1em" viewBox="0 0 16 16" class="top" fill="currentColor" xmlns="http://www.w3.org/­2000/svg">
...
<?php  endwhile; 
  ...
  <span style="text-align:justify;margin-left: 40%;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:18px;color:#9f9b9a;">Sem clientes cadastrados no sistema!</span>
