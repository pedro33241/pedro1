...
<link rel="stylesheet" type="text/css" href="css/rel.css">
<?php 
...
<li class="list"><a href="rel.php"  rel="next"  style="background:#1e1e1e;border-bottom:none" class="ref" >
<span  style="  color:#00b7ff" >  <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="icon6" fill="currentColor"
 ...
 2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/></svg></span > <svg width="1em" class="left" height="1em" viewBox="0 0 16 16" class="bi bi-caret-left" fill="currentColor" xmlns="http://www.w3.org/­2000/svg">
<path fill-rule="evenodd" d="M10 12.796L4.519 8 10 3.204v9.592zm-.659.7­53l-5.48-4.796a1 1 0 0 1 0-1.506l5.48-4.796A1­ 1 0 0 1 11 3.204v9.592a1 1 0 0 1-1.659.753z"/>
</svg>
<br> <span class="ref_none">
Relatório</span> 
...
<section id="main"><label  id="btnTop1" class="btnTop1"> <h3 style="font-weight:normal;" ><svg width=".7em" height=".7em" viewBox="0 0 16 16" class="icon6" fill="currentColor"
 xmlns="http://www.w3.org/­2000/svg"> <path fill-rule="evenodd" d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 
 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-
 2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/></svg> Relatório do Faturamento</h3>
 ...
 xmlns="http://www.w3.org/­2000/svg"> <path fill-rule="evenodd" d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 
 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-
 2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/></svg> Relatório do Faturamento</label> <br></h3>
  <nav id="atualizar" title="Procurar">
<form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>"><div class="RNNXgb" jsname="RNNXgb"><div class="SDkEP"><div class="iblpc" jsname="uFMOof"> <div class="hsuHs"><span class="wFncld z1asCe MZy1Rb"><svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24"><path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"></path></svg></span></div></div><div jscontroller="iDPoPb" class="a4bIc" jsname="gLFyf" jsaction="h5M12e;input:d3sQLd;blur:jI3wzf"> <div class="pR49Ae gsfi" jsname="vdLsw"></div><input class="gLFyf yy1 gsfi" maxlength="2048" name="q" type="search" jsaction="paste:puy29d" aria-autocomplete="both" placeholder="Procurar Fatura" aria-haspopup="false" autocapitalize="off" autocomplete="off" autocorrect="off" autofocus="" role="combobox" spellcheck="false" title="Pesquisar" value="" aria-label="Pesq." data-ved="0ahUKEwjziqjGhZztAhWvz4UKHSiFDTIQ39UDCAQ"></div><div class="dRYYxd">   <span class="FqnKTc"></span></nav>
 <br>
<div id="conteudo3" >

  <?php 

          $sql= "SELECT * FROM  view_faturamento ORDER BY id desc";
...
?>  <div class="  container" > 
  <table cellspacing="8"  class="f5 " > <br>
...
<tr style="color:#000000;
        ...
        ">  
         ...
         <td style="color:#373941">Pagamento</td>
         <td style="color:#373941">Valor entregue</td>  
      <td style="color:#373941">valor pagar</td>
     <td style="color:#373941">Nif</td>
    <td style="color:#373941">Morada da Fatura</td>
  <td style="color:#373941">Entidade</td>
...
.p6{  font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;
 ...
 width:97%;padding:7px 25px 7px 25px; border:none;font-size:14px;
     ...
     <td   ><button type="submit" title="Deletar Registo" style=" border-radius:4%;border:none; "><span ><a href="backend/delete3.php?id=<?php echo $dados['id'];?>" onclick="return confirm('Tem certeza que deseja deletar esse relatório?' ); return false;" class="p4">Apagar</a></span></button></td>
...
<td style="border:none;color:#a90969;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:18px; "><?php echo $dados['pagamento'];?></td> 

<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['valor_entregue'];?></td>
<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['valor_pagar'];?></td>
<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['nif'];?></td>
<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['morada'];?></td>
<td  style="color:#0086ae;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['entidade'];?></td>
...
<td style="color:#373941">Efectivo</td>
<td style="color:#373941">Data da Factura</td>
<td style="color:#373941">Code</td>
<td style="color:#373941">Operador/a</td>
<td class="p" ><button type="submit" title="Imprimir Registo" style=" 
 border-radius:4%;border:none; " onclick=" "><span class="p"><a href="rel.php?id=<?php echo $dados['id'];?>" class="p6">Imprimir</a></span></button></td>

</tr> <tr> 

<td  style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['nome'];?></td>
...
<td  style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['efectivo'];?></td>
<td  style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['datac'];?></td>
<td  style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['codi'];?></td>
<td style="color:#395f80;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:17px; "><?php echo $dados['operador'];?></td>
...
<?php  endwhile; 
  ...
  <span style="text-align:center;margin-left: 40%;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:18px;color:#9f9b9a;">Sem registo de Faturamento!</span>
...
<path fill-rule="evenodd" d="M10 12.796L4.519 8 10 3.204v9.592zm-.659.7­53l-5.48-4.796a1 1 0 0 1 0-1.506l5.48-4.796A1­ 1 0 0 1 11 3.204v9.592a1 1 0 0 1-1.659.753z"/></button> 
    ...
    function scroll(){
      ...
      if(document.documentElement.scrollTop > 50){
        btn.style.display = "block";  btn.style.transition= "4s"; 
